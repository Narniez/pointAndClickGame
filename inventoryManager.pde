//Keeps track of which objects we have collected already
//It has a list of all objects we collected
// We can add objects directly and check whether we have a collectable or not 
